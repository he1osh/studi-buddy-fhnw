...
- **Laufende Instanz:** [Link folgt]
- **Präsentation:** [Link folgt]

## Projektübersicht

| Phase | Beschreibung | Status |
|-------|-------------|--------|
| Define | Use Cases, User & Bot Persona | ⬜ Offen |
| Design | Sample Dialogues, Happy Path, Prototyp | ⬜ Offen |
| Architect | Informationsbedarf, Kanäle, Framework, Architektur | ⬜ Offen |
| Build & Train | Bot-Entwicklung, NLU-Training, Kanalintegration | ⬜ Offen |
| Release & Operate | Veröffentlichung, Monitoring | ⬜ Offen |

## Dokumentation

- [Use Cases](docs/use-cases.md)
- [User Persona](docs/user-persona.md)
- [Bot Persona](docs/bot-persona.md)
- [Sample Dialogues](docs/sample-dialogues.md)
- [Architektur](docs/architecture.md)

## Technologie-Stack

- **Framework:** [z. B. Voiceflow / Botpress / RASA]
- **Integration:** [z. B. Make.com + Google Sheets]
- **Kanal:** [z. B. Web Chat]
- **Knowledge Base:** [z. B. FAQ-Dokument, Studienreglement]

## Modul

Dialogsysteme und Sprachverarbeitung – FS 2026  
Prof. Dr. Andreas Martin & Charuta Pande  
